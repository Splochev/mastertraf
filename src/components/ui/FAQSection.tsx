...
export function FAQSection({ items, title = "Често задавани въпроси" }: { items: FAQItem[]; title?: string }) {
  return (
    <section aria-labelledby="faq-heading">
      <h2 id="faq-heading" className="text-2xl font-bold text-neutral-900 sm:text-3xl">
        {title}
      </h2>
    ...
    <div className="rounded-xl border border-neutral-200 bg-white transition-shadow hover:shadow-sm">
      <dt>
        <button
          ...
          aria-expanded={open}
        >
          <span className="text-base font-medium text-neutral-900">{item.questionBg}</span>
          <svg
