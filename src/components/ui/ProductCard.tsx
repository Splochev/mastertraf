    ...
    <article className="group rounded-2xl border border-neutral-200 bg-white transition-all hover:shadow-lg hover:border-primary-200">
      <Link href={`/produkti/${product.slug}`} className="block">
        ...
        <div className="p-5">
          ...
          {product.price && (
            <div className="mt-3 inline-flex items-center gap-1.5 rounded-lg bg-primary-50 px-3 py-1.5">
              ...
              <span className="text-xs font-semibold text-primary-700">{product.price}</span>
            </div>
          )}
