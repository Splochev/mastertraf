          ...
          <div className="mt-6 grid gap-6 sm:grid-cols-2">
            <div className="rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <p className="mt-2 text-neutral-600">
                Проектираме и изработваме по поръчка специализирани
                трансформаторни машини и апарати, съобразени с индивидуалните
                изисквания и нужди на клиента.
              </p>
            </div>
            <div className="rounded-2xl border border-neutral-200 bg-white p-6">
              <h3 className="text-lg font-semibold text-primary-600">Ремонт</h3>
              <p className="mt-2 text-neutral-600">
                Извършваме ремонт на монофазни и трифазни трансформаторни машини
                и апарати, включително заваръчна техника, телоподаващи
                устройства, електросъпротивителни машини за заваряване и
                нагряване на метали (спотери), зарядни и стартерно-зарядни
                устройства, захранващи източници и друго специализирано
                оборудване.
              </p>
            </div>
            <div className="rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <p className="mt-2 text-neutral-600">
                Извършваме диагностика и профилактика на трансформаторна
                техника, като оценяваме техническото ѝ състояние и предоставяме
                препоръки за поддръжка, ремонт и оптимална експлоатация.
              </p>
            </div>
            <div className="rounded-2xl border border-neutral-200 bg-white p-6">
              <h3 className="text-lg font-semibold text-primary-600">
                Рециклиране и преоборудване
              </h3>
              <p className="mt-2 text-neutral-600">
                Извършваме рециклиране и възстановяване на стари трансформаторни
                машини и апарати, както и преоборудване на техника с хоби и
                полупрофесионално предназначение за професионална
                експлоатация.
              </p>
            </div>
          </div>
