      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <Breadcrumbs
          items={[
            ...
            { label: service.titleBg },
          ]}
        />

        {/* Service Detail */}
        <div className="mt-8 grid gap-10 lg:grid-cols-2">
          {/* Images or Icon Section */}
          <div>
            {service.images && service.images.length > 0 ? (
              ...
              <div className="flex items-center justify-center rounded-2xl bg-primary-50 p-12">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              >
                ...
                <span className="flex flex-col leading-tight">
                  ...
                  <span className="text-sm font-medium text-white/90">+359 888 709 404</span>
                </span>
              </a>
              <Link
                href="/kontakti"
        ...
        {relatedServices.length > 0 && (
          <section className="mt-20" aria-labelledby="related-services">
            <h2
              id="related-services"
            ...
            <div className="mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {relatedServices.map((relatedService) => (
                <Link
                  ...
                  className="group rounded-2xl border border-neutral-200 bg-white p-6 transition-all hover:shadow-lg hover:border-primary-200"
                >
                  <div className="mb-4 inline-flex rounded-xl bg-primary-50 p-3 text-primary-600 group-hover:bg-primary-100">
                    {iconMap[relatedService.icon] || iconMap.wrench}
                  </div>
                  <h3 className="text-lg font-semibold text-neutral-900 group-hover:text-primary-600">
                    {relatedService.titleBg}
                  </h3>
                  <p className="mt-2 text-sm leading-relaxed text-neutral-600">
                    {relatedService.descriptionBg}
                  </p>
                </Link>
              ))}
            </div>
