      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="mt-6">
          ...
          <p className="mt-3 max-w-3xl text-lg text-neutral-600">
            Предлагаме проектиране, изработка, ремонт и поддръжка на трансформаторна и заваръчна техника, включително специализирани машини, трансформатори и захранващи източници. Фокусираме се върху надеждност и дълъг експлоатационен живот на оборудването.
          </p>
        </div>
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((service) => (
            <ServiceCard key={service.id} service={service} pageIsServices={!!service.price} showLink={true} />
          ))}
        </div>
