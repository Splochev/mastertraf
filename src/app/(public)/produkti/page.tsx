      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="mt-6">
          ...
          <p className="mt-3 max-w-2xl text-lg text-neutral-600">
            За нас всеки проект е индивидуален. Работим с внимание към детайла, коректно отношение и стремеж към максимална надеждност на всяко изделие. Българска трансформаторна техника с професионално качество и доказана надеждност. Всички продукти са с 24 месеца гаранция и осигурено следгаранционно обслужване.
          </p>
        </div>
